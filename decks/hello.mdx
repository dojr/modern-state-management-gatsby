...
- React hooks and context allows state contained within only the components that need it ✔

- Components outside that never use this state don't have access to it now ✔

- Co-locating state with the components that use it and avoid prop drilling at the same time ✔
